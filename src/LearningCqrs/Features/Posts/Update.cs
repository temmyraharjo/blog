...
public class Update
{
    ...
    public class UpdatePostHandler : Core.Handler.Update.UpdateDocumentHandler<UpdatePostCommand, Post>
    {
        ...
        public override Task<Post> Handling(Post entity,
            Core.Handler.Update.UpdateDocument<UpdatePostCommand, Post> request, CancellationToken cancellationToken)
        {
            ...
            {
                if (entity.PostCategories != null && entity.PostCategories.Any()) entity.PostCategories.Clear();
